...
const delay = 30000;
const heroVideo = "https://www.youtube.com/embed/_vmtN0r3i3I";
const Slider = () => {
  ...
  return (
    <Stack direction="row" sx={{ position: "relative", height: "100vh" }}>
      ...
      {/* <iframe
        // src="https://www.youtube.com/embed/_vmtN0r3i3I"
        src="https://www.youtube.com/embed?v=_vmtN0r3i3I"
        frameborder="0"
      ...
      {/* {SlideItems.map((slide) => {
        return (
          <React.Fragment key={slide.id}>
            ...
            >
              <Typography variant="h3" sx={slideTitle} color="white">
                {slide.title}
              </Typography>
              <Typography variant="h4" sx={slideTag}>
                {slide.tagline}
              </Typography>
