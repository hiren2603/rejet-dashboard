...
import {
  ...
  inkSystem,
  benifits,
} from "@/helpers/re2000p_Data";
import { productHeading, modelHeading, headings, ProductImg } from "./style";
import { printHead } from "helpers/re2000p_data";
import { Fragment } from "react";

const Re2000p = () => {
  return (
    <>
      <Head title="Re2000P" description="Radhe Enterprise Re2000P Page" />
      <Grid
        container
        width={"90%"}
        sx={{ margin: "0 auto" }}
      ...
      >
        ...
        <Heading name="RE2000P" type="INKJET PRINTER" pdf={CatalougFile} />
        <Grid
          container
          item
          direction={"row"}
